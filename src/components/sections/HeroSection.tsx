...
function CodeToWebScene() {
  ...
  // Usar refs para almacenar las funciones y evitar errores de inmutabilidad
  ...
  useEffect(() => {
    const startSequence = () => {
      ...
      label.textContent = '⌨️ escribiendo código...';
      ...
      typeLinesFn(CODE_LINES, 0, () => {
        later(() => {
          if (label) label.textContent = '⚙️ compilando...';
          spawnParticles();
          ...
          later(() => {
            ...
            if (label) label.textContent = '🌐 renderizando interfaz...';
            spawnParticles();
  ...
  }, [clearTimers, spawnParticles, later]);
  ...
  useEffect(() => {
    ...
    s.textContent = `
      ...
      .sc-cursor {
        ...
        animation: sc-blink .9s step-end infinite;
      }
      @keyframes sc-blink {
        0%, 100% { opacity: 1; }
        50% { opacity: 0; }
      ...
      .sc-web-panel {
        ...
        top: 50%;
        left: 50%;
        transform: translate(-50%,-50%) perspective(900px) rotateY(30deg) scale(1);
        width: 460px;
        border-radius: 12px;
        overflow: hidden;
        opacity: 0;
        box-shadow: 0 0 80px rgba(0,229,255,.15);
        z-index: 9;
      }
      .sc-web-bar {
        background: #1a1a2e;
      ...
      .sc-logo-img {
        ...
        display: block;
        margin: 0 auto;
        filter: drop-shadow(0 0 48px rgba(0,229,255,0.5)) drop-shadow(0 0 20px rgba(0,180,255,0.4));
      }
      .sc-logo-label {
        font-family: monospace;
        font-size: 14px;
    ...
    <div ref={sceneRef} className="sc-scene">
      ...
      <div ref={webPanelRef} className="sc-web-panel">
        ...
        <div className="sc-web-hero">
          <div className="sc-web-tag">Full-Stack Studio</div>
          <div className="sc-web-title">Symmetrical<span>Code</span></div>
          <div className="sc-web-sub">Diseño + código que escala.</div>
          <div className="sc-web-btns">
            <button className="sc-btn-p">Ver proyectos</button>
            <button className="sc-btn-o">Contactar</button>
          </div>
        </div>
        <div className="sc-web-cards">
          {[
            { Icon: IconReact, bg: 'rgba(0,180,216,.12)', title: 'React', desc: 'Interfaces reactivas' },
            { Icon: IconNode, bg: 'rgba(134,239,172,.12)', title: 'Node.js', desc: 'Backend escalable' },
            { Icon: IconTS, bg: 'rgba(253,230,138,.12)', title: 'TypeScript', desc: 'Código robusto' },
        ...
        <div className="flex flex-col justify-center px-8 lg:px-14 pt-24 pb-12">
          ...
          >
            <div className="flex flex-col gap-2.5">
              {[
                { icon: <MailIcon />, text: 'atencionaclientes@symmetricalcode.com' },
                { icon: <MapIcon />, text: 'Guanajuato, México · Remoto' },
                { icon: <CodeIconSm />, text: 'Disponible para nuevos proyectos' },
              ].map((item, i) => (
            ...
            <div className="flex flex-col gap-2.5">
              <div className="flex flex-wrap gap-1.5">
                {techs.map((tech) => (
                  <span
                    key={tech}
                    className="font-mono text-[0.62rem] text-[#00e5ff]/55 border border-[rgba(0,229,255,0.13)] px-2 py-0.5"
                  >
                    {tech}
                  </span>
                ))}
