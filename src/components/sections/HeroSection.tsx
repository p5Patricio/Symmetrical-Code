...
/* ─── Icons ─── */
const FacebookIcon = () => <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.891h-2.33v6.987C18.343 21.128 22 16.991 22 12z"/></svg>;
...
const MapIcon = () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M20 10c0 6-8 12-8 12s-8-6-8-10a8 8 0 0116 0z"/><circle cx="12" cy="12" r="3"/></svg>;
...
function CodeToWebScene() {
  ...
  useEffect(() => {
    ...
    s.textContent = `
      ...
      .sc-line { white-space:pre-wrap; word-break:break-word; }
      ...
      .sc-web-btns { display:flex;gap:10px;flex-wrap:wrap; }
      ...
      .sc-web-cards { background:#070d14;padding:14px 16px;display:grid;grid-template-columns:repeat(auto-fit, minmax(110px, 1fr));gap:10px; }
      ...
      @media (max-width: 640px) {
        ...
        .sc-web-title { font-size: 18px; }
        .sc-web-hero { padding: 20px 16px; }
        .sc-code-body { padding: 16px; font-size: 11px; }
        .sc-logo-img { width: 150px; height: 150px; }
        .sc-logo-label { font-size: 11px; letter-spacing: .2em; }
      }
    `;
        ...
        <div className="flex flex-col justify-center px-5 sm:px-8 lg:px-14 pt-20 sm:pt-24 pb-12">
          ...
          >
            ...
            <div className="flex flex-col gap-3 max-w-sm">
              <p className="font-mono text-[0.66rem] leading-relaxed text-white/35 border-l border-[rgba(0,229,255,0.18)] pl-3 text-justify">
              ...
              <div className="flex items-center gap-3 mt-0.5">
                ...
                <div className="flex gap-3">
                  {[
                    { icon: <FacebookIcon />, href: 'https://www.facebook.com/profile.php?id=61591503452553', label: 'Facebook' },
                    { icon: <LinkedInIcon />, href: 'https://www.linkedin.com/company/symmetrical-code', label: 'LinkedIn' },
                    { icon: <InstagramIcon />, href: 'https://www.instagram.com/symmetrical.code', label: 'Instagram' },
                  ].map((s) => (
                    <a
                      key={s.label}
                      href={s.href}
